! function (s) {
    ...
    r.prototype.respChart = function (r, o, a, e) {
        ...
        this.respChart(s("#doughnutus"), "Doughnut", {
            ...
            datasets: [{
                data: [$("#daduyet").data("value"), $("#choduyet").data("value"), $("#baoban").data("value"), $("#huy").data("value")],
                backgroundColor: ["#3ac9d6", "#ebeff2", "#CC0000","#87CEFA"],
                hoverBackgroundColor: ["#3ac9d6", "#ebeff2", "#CC0000","#87CEFA"],
        ...
        this.respChart(s("#pieus"), "Pie", {
            ...
            datasets: [{
                data: [$("#hoanthanh").data("value"), $("#chuahoanthanh").data("value"), $("#sap").data("value")],
